...
export default function Footer({
  ...
  const footerLinks = [
    {
      ...
      links: [
        ...
        { label: "Our Vision", href: "#who-we-are" },
        { label: "Our Mission", href: "#who-we-are" },
        { label: "Our Impact", href: "#explore-our-work" },
      ],
    },
    {
      title: "Programs",
      links: [
        ...
        { label: "Fellowship Support", href: "#" },
        { label: "Scientific Missions", href: "#" },
      ],
    },
    {
      title: "Resources",
  ...
  return (
    <footer className="relative bg-gradient-to-b from-[#EC601B] via-[#F7911E] to-[#EC601B] text-white overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-[5%] py-12 lg:py-16">
        {/* Main Footer Content */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-white/90 mb-6 leading-relaxed max-w-md">
              ...
              Fostering science, technology, and innovation to address national
            ...
            <div className="flex items-center gap-4">
              {socialLinks.map((social, index) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-white/20 hover:bg-white/30 flex items-center justify-center text-white hover:text-white transition-all duration-300 border border-white/30 hover:border-white/50"
